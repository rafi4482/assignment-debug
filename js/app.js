...
const updatePrice = (id, value) => {
  setInnerText(id,getInputValue(id)+value);
...
const updateTaxAndCharge = () => {
  ...
  if (getInputValue("price") > 500) {
      setInnerText("delivery-charge", 60);
      setInnerText("total-tax", (getInputValue("price") * 0.4).toFixed(2));
    }
    else
    if (getInputValue("price") > 400) {
      setInnerText("delivery-charge", 50);
      setInnerText("total-tax", (getInputValue("price") * 0.3).toFixed(2));
    }
    else
    if (getInputValue("price") > 200) {
    setInnerText("delivery-charge", 30);
    setInnerText("total-tax", getInputValue("price") * 0.2);
  }
